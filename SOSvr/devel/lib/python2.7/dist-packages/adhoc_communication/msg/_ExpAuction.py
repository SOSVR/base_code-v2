...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3B.pack(_x.auction_status_message, _x.start_auction, _x.auction_finished))
      ...
      buff.write(_struct_I.pack(self.auction_id))
      _x = self.robot_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.auction_status_message, _x.start_auction, _x.auction_finished,) = _struct_3B.unpack(str[start:end])
      ...
      (self.auction_id,) = _struct_I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
